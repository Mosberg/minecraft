...
1. Download the latest `.jar` release from [CurseForge/Modrinth link here].
2. Place the file in your `mods/` folder.
3. Launch Minecraft with Fabric/Forge (depending on your build).
...
- **Author:** Mosberg
- **Design & Development:** Modular systems, schema validation, balancing.
